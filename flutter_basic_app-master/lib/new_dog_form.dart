  ...
  void submitPup(BuildContext context) {
    if (nameController.text.isEmpty) {
      Scaffold.of(context).showSnackBar(new SnackBar(
        ...
        content: new Text('Necesita un nombre el personaje!'),
      ));
    } else {
          ...
          child: new Column(children: [
            new Padding(
              ...
              child: new TextField(
                ...
                decoration:
                    new InputDecoration(labelText: 'Nombre del Personaje'),
              ),
            ),
            new Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: new TextField(
                ...
                decoration: new InputDecoration(labelText: "Elemento"),
              ),
            ),
            new Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: new TextField(
                ...
                decoration: new InputDecoration(labelText: 'Rareza'),
              ),
            ),
            new Padding(
              ...
              child: new Builder(
                builder: (context) {
                  return new RaisedButton(
                    ...
                    child: new Text('Introducir Personaje'),
                  );
                },
              ),
            )
